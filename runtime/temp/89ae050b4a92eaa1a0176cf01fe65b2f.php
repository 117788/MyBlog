<?php /*a:3:{s:59:"D:\wamp64\www\MyBlog\application\admin\view\links\edit.html";i:1553688936;s:59:"D:\wamp64\www\MyBlog\application\admin\view\common\top.html";i:1553398483;s:60:"D:\wamp64\www\MyBlog\application\admin\view\common\left.html";i:1553688118;}*/ ?>
<!DOCTYPE html>
<html>

	<head>
		<meta charset="utf-8">
		<title>编辑友情链接 - Mr.Wang - Blog</title>
										...
										<div class="widget-body">
											...
											<div id="horizontal-form">
												<form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data">
													<input type="hidden" name="id" value="<?php echo htmlentities($link['id']); ?>" />
													<div class="form-group">
														<label for="name" class="col-sm-2 control-label no-padding-right">网站名称</label>
														<div class="col-sm-6">
															<input class="form-control" id="name" placeholder="友情链接标题" name="name" type="text" value="<?php echo htmlentities($link['name']); ?>">
														</div>
													...
													<div class="form-group">
														...
														<div class="col-sm-6">
															<input class="form-control" id="url" placeholder="友情链接URL" name="url" type="text" value="<?php echo htmlentities($link['url']); ?>">
														</div>
														<p class="help-block col-sm-4 red">* 必填</p>
													</div>
													<div class="form-group">
														...
														<div class="col-sm-6">
															<input class="form-control" id="info" placeholder="友情链接简介" name="info" type="text"value="<?php echo htmlentities($link['info']); ?>">
														</div>
														<p class="help-block col-sm-4 red">* 必填</p>
													</div>
