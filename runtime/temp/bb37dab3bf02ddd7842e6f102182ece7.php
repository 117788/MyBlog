<?php /*a:3:{s:60:"D:\wamp64\www\MyBlog\application\admin\view\project\add.html";i:1553698571;s:59:"D:\wamp64\www\MyBlog\application\admin\view\common\top.html";i:1553833963;s:60:"D:\wamp64\www\MyBlog\application\admin\view\common\left.html";i:1553834037;}*/ ?>
<!DOCTYPE html>
<html>

	<head>
		<meta charset="utf-8">
		<title>添加项目 - Mr.Wang - Blog</title>
								...
								<div class="col-lg-12 col-sm-12 col-xs-12">
									<div class="widget">
										<div class="widget-header bordered-bottom bordered-blue">
											<span class="widget-caption">新增项目</span>
										</div>
											...
											<div id="horizontal-form">
												<form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data">
													<div class="form-group">
														<label for="name" class="col-sm-2 control-label no-padding-right">项目名称</label>
														<div class="col-sm-6">
															<input class="form-control" id="name" placeholder="项目名称" name="name" type="text">
														</div>
													...
													<div class="form-group">
														...
														<div class="col-sm-6">
															<input class="form-control" id="info" placeholder="项目简介" name="info" type="text">
														</div>
														<p class="help-block col-sm-4 red">* 必填</p>
													</div>
													<div class="form-group">
													...
													<div class="form-group">
														...
														<div class="col-sm-6">
															<label>
                                    							<input class="checkbox-slider colored-darkorange" name="original"  type="checkbox">
													...
													<div class="form-group">
														...
														<div class="col-sm-6">
															<label>
                                    							<input class="checkbox-slider colored-blue" name="complete"  type="checkbox">
                                    							<span class="text"></span>
                                 							</label>
														</div>
													</div>
													<div class="form-group">
														...
														<div class="col-sm-6">
															<input class="form-control" id="gitUrl" placeholder="GitBook链接" name="gitUrl" type="text">
														</div>
														<p class="help-block col-sm-4 red">* 必填</p>
													</div>
													<div class="form-group">
