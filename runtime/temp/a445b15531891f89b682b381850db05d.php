<?php /*a:3:{s:59:"D:\wamp64\www\MyBlog\application\admin\view\about\edit.html";i:1553694735;s:59:"D:\wamp64\www\MyBlog\application\admin\view\common\top.html";i:1553398483;s:60:"D:\wamp64\www\MyBlog\application\admin\view\common\left.html";i:1553694805;}*/ ?>
<!DOCTYPE html>
<html>
		...
		<div class="main-container container-fluid">
								...
								<div class="col-lg-12 col-sm-12 col-xs-12">
									<div class="widget">
										<div class="widget-header bordered-bottom bordered-blue">
											<span class="widget-caption">关于</span>
										</div>
											...
											<div id="horizontal-form">
												<form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data">
													<div class="form-group">
														<label for="text" class="col-lg-2 control-label no-padding-right">关于我</label>
														<div class="col-lg-10">
															<textarea id="aboutMe"><?php echo htmlentities($about['aboutMe']); ?></textarea>
															<input type="hidden" id="editorText1" value="" name="editorText1" />
														</div>
													</div>
													<div class="form-group">
														<label for="text" class="col-lg-2 control-label no-padding-right">关于博客</label>
														<div class="col-lg-10">
															<textarea id="aboutBlog"><?php echo htmlentities($about['aboutBlog']); ?></textarea>
															<input type="hidden" id="editorText2" value="" name="editorText2" />
														</div>
													</div>
			...
			<script type="text/javascript">
				$(function() {
					...
					$('#aboutBlog').froalaEditor({
						language: 'zh_cn',
						heightMin: 100,
						heightMax: 200,
						placeholderText: '关于博客',
						pastePlain: true,
						theme: 'dark',
						toolbarSticky: false,
						quickInsertTags: [''],
					...
					$('#toSave').click(function() {
						var html1 = $('#aboutMe').froalaEditor('html.get');
						var html2 = $('#aboutBlog').froalaEditor('html.get');
						$('#editorText1').val(html1);
						$('#editorText2').val(html2);
						$.ajax({
							url: "<?php echo url('about/edit'); ?>",
							type: 'post',
							data: $('form').serialize(),
							dataType: 'json',
