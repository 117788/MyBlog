<?php /*a:3:{s:61:"D:\wamp64\www\MyBlog\application\admin\view\article\edit.html";i:1553417888;s:59:"D:\wamp64\www\MyBlog\application\admin\view\common\top.html";i:1553398483;s:60:"D:\wamp64\www\MyBlog\application\admin\view\common\left.html";i:1553434825;}*/ ?>
<!DOCTYPE html>
<html>

	<head>
		<meta charset="utf-8">
		<title>编辑文章 - Mr.Wang - Blog</title>
										...
										<div class="widget-body">
											...
											<div id="horizontal-form">
												<form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data">
													<input type="hidden" name="id" value="<?php echo htmlentities($articles['id']); ?>" />
													<div class="form-group">
														<label for="title" class="col-sm-2 control-label no-padding-right">文章标题</label>
														<div class="col-sm-6">
															<input class="form-control" id="title" placeholder="文章标题" name="title" type="text" value="<?php echo htmlentities($articles['title']); ?>">
														</div>
													</div>
													<div class="form-group">
														<label for="info" class="col-sm-2 control-label no-padding-right">文章简介</label>
														<div class="col-sm-6">
															<input class="form-control" id="info" placeholder="文章简介" name="info" type="text" value="<?php echo htmlentities($articles['info']); ?>">
														</div>
													</div>
													<div class="form-group">
														<div id="element_id">
															...
															<select class="tag1" name="tag1" style="width: 100px;">
																<option value="<?php echo htmlentities($articles['tag1']); ?>" selected><?php echo htmlentities($articles['tag1']); ?></option>
															</select>
															</label>
															</div>
															...
															<select class="tag2" name="tag2" style="width: 100px;">
																<option value="<?php echo htmlentities($articles['tag2']); ?>" selected><?php echo htmlentities($articles['tag2']); ?></option>
															</select>
															</label>
															</div>
													...
													<div class="form-group">
														<div class="layui-upload">
															...
															<div class="col-sm-6">
																...
																<img src="http://localhost/myblog/public/static/<?php echo htmlentities($articles['img']); ?>"  width="100" height="100" style="float: right;" >
													...
													<div class="form-group">
														...
														<div class="col-sm-6">
															<label>
                                    							<input class="checkbox-slider colored-darkorange" name="state" <?php if($articles['top'] == 1): ?>checked="checked"<?php endif; ?> type="checkbox">
													...
													<div class="form-group">
														...
														<div class="col-lg-9">
															<div id="test-editormd">
																<textarea style="display:none;"><?php echo htmlentities($articles['text']); ?></textarea>
